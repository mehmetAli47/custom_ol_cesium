export class ImageFileDirectory {
     ...
     */
    hasTag<T extends import("./globals.js").TagName = any>(tagIdentifier: T | number): this is {
        getValue(t: T): NonNullable<import("./globals.js").TagValue<T>>;
    } & import("./imagefiledirectory").ImageFileDirectory;
    /**
